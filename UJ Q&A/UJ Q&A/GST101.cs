...
{
	/// <summary>
	/// Description of GST101.
	/// </summary>
	public partial class GST101 : Form
	{
		...
		void GST101_Load(object sender, EventArgs e)
		{
		...
		{
			button28.Text="A mother tongue is also referred to as a __";
		...
		{
			button29.Text="Which of the following types of speech is extemporaneous";
			radioButton113.Text="(a) Formal";
			radioButton114.Text="(b) Informal";//ans
			radioButton115.Text="(c) Jocular";
			radioButton116.Text="(d) Official";
		}
		void panel30_Paint(object sender, PaintEventArgs e)
		{
			button30.Text="...... is the systematic arrangement of library materials";
			radioButton117.Text="(a) Catalouguing";//ans
			radioButton118.Text="(b) Catalogue";
			radioButton119.Text="(c) Classification";
			radioButton120.Text="(d) Similarity";
		}
